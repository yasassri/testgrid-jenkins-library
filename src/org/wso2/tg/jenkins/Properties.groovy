...
class Properties implements Serializable {
    ...
    static def TOMCAT_PASSWORD          = credentials('TOMCAT_PASSWORD')
    static def WUM_UAT_URL              = credentials('WUM_UAT_URL')
    static def WUM_UAT_APP_KEY          = credentials('WUM_UAT_APPKEY')
    static def USER_NAME                = credentials('WUM_USERNAME')
